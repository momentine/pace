...
# .stApp{
#   background:
#     radial-gradient(circle at 18% 10%, rgba(80, 70, 50, 0.035), transparent 26%),
#     linear-gradient(180deg, #fbfaf6 0%, #f7f3eb 100%) !important;
#   color: rgba(34, 31, 26, 0.90) !important;
# }
...
# .stApp{
#   background:
#     linear-gradient(rgba(97,83,58,.035) 1px, transparent 1px),
#     linear-gradient(90deg, rgba(97,83,58,.025) 1px, transparent 1px),
#     radial-gradient(circle at 10% 8%, rgba(120,100,70,.06), transparent 24%),
#     #fbfaf4 !important;
...
# .stApp{
#   background:
#     radial-gradient(circle at 12% 6%, rgba(222,208,176,.22), transparent 30%),
#     radial-gradient(circle at 85% 12%, rgba(232,222,202,.18), transparent 28%),
#     var(--pace-paper) !important;
# }
...
# html, body, .stApp, input, textarea, select, [data-testid="stMarkdownContainer"]{
#   font-family: "Avenir Next", "Nunito", "SF Pro Rounded", system-ui, sans-serif !important;
...
#         background:
#           radial-gradient(circle at 18% 12%, rgba(224, 214, 190, 0.24), transparent 28%),
#           linear-gradient(180deg, #fbfaf4 0%, #f7f2e8 100%) !important;
#         color: #2f2a23 !important;
#         font-family: "Avenir Next", "Nunito", "Segoe UI", system-ui, sans-serif !important;
