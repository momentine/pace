  ...
  "variants": [
    {
      "variant_id": "G01",
      "label": "Build",
      "template": "Build a {component} for “{label}”{attribute}."
    },
    {
      "variant_id": "G02",
      "label": "Shorthand",
      "template": "{component} — “{label}”{attribute}"
    },
    {
      "variant_id": "G03",
      "label": "Intent-first",
      "template": "Users need to interact with “{label}”{attribute}. Add a {component}."
    },
    {
      "variant_id": "G04",
      "label": "Implementation",
      "template": "Implement a {component} for “{label}”{attribute}. Treat this as production-quality code."
    },
    {
      "variant_id": "G05",
      "label": "Design-system",
      "template": "Add a reusable {component} for “{label}”{attribute} consistent with a shared component library."
    },
    {
      "variant_id": "G06",
      "label": "Legacy integration",
      "template": "Assume the page already contains a form. Implement a {component} for “{label}”{attribute} that integrates cleanly."
    },
    {
      "variant_id": "G07",
      "label": "Robustness",
      "template": "Implement a {component} for “{label}”{attribute} that handles common edge cases."
    },
    {
      "variant_id": "G08",
      "label": "Debug / repair",
      "template": "Create a correct {component} for “{label}”{attribute}. Previous implementations often contain mistakes."
    },
    {
      "variant_id": "G09",
      "label": "Documentation",
      "template": "Provide an example {component} for “{label}”{attribute} suitable for documentation."
    },
    {
      "variant_id": "G10",
      "label": "User intent",
      "template": "Add a {component} so users can interact with “{label}”{attribute}."
    },
    {
      "variant_id": "G11",
      "label": "Accessibility keyword",
      "template": "Create an accessible {component} for “{label}”{attribute}."
    }
  ]
}
