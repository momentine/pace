...
PACE is a benchmarking framework for evaluating accessibility in HTML generated by large language models. It supports controlled experiments across models, system instructions, form components, and request variants.
...
2. **Evaluation pipeline**  
   The `bench/` package contains the execution engine, axe-core runner, schema scorer, registry manager, OpenRouter client, and I/O utilities.
